...
_accountSid = '8a216da86f17653b016f4d602b4d2620'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '74b5018e30874943bd75f4f51d8f6a5e'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da86f17653b016f4d602bbf2627'
...
if __name__ == '__main__':
    # 注意： 测试的短信模板编号为1
    # sendTemplateSMS('13155950101', ['123456', 5], 1)

    # 创建单例类,调用发送短信单例方法
    CCP().send_template_sms('13155950101',['123456'], 1)